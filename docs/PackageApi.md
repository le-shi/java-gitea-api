...
try {
    apiInstance.deletePackage(owner, type, name);
...
> deletePackageVersion(owner, type, name, version)
...
try {
    apiInstance.deletePackageVersion(owner, type, name, version);
} catch (ApiException e) {
