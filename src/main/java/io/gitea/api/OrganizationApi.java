...
import io.gitea.model.ActionRunnersResponse;
...
import io.gitea.model.EditActionRunnerOption;
...
public class OrganizationApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ActionRunner getOrgRunner(String org, String runnerId) throws ApiException {
        ApiResponse<ActionRunner> resp = getOrgRunnerWithHttpInfo(org, runnerId);
        return resp.getData();
    }
     ...
     * @param org name of the organization (required)
     * @param runnerId id of the runner (required)
     * @return ApiResponse&lt;ActionRunner&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ActionRunner> getOrgRunnerWithHttpInfo(String org, String runnerId) throws ApiException {
        com.squareup.okhttp.Call call = getOrgRunnerValidateBeforeCall(org, runnerId, null, null);
        Type localVarReturnType = new TypeToken<ActionRunner>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOrgRunnerAsync(String org, String runnerId, final ApiCallback<ActionRunner> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getOrgRunnersCall(String org, Boolean disabled, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrgRunnersValidateBeforeCall(String org, Boolean disabled, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOrgRunnersCall(org, disabled, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ActionRunnersResponse getOrgRunners(String org, Boolean disabled) throws ApiException {
        ApiResponse<ActionRunnersResponse> resp = getOrgRunnersWithHttpInfo(org, disabled);
        return resp.getData();
    }
     ...
     * @param org name of the organization (required)
     * @param disabled filter by disabled status (true or false) (optional)
     * @return ApiResponse&lt;ActionRunnersResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ActionRunnersResponse> getOrgRunnersWithHttpInfo(String org, Boolean disabled) throws ApiException {
        com.squareup.okhttp.Call call = getOrgRunnersValidateBeforeCall(org, disabled, null, null);
        Type localVarReturnType = new TypeToken<ActionRunnersResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOrgRunnersAsync(String org, Boolean disabled, final ApiCallback<ActionRunnersResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOrgRunnersValidateBeforeCall(org, disabled, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ActionRunnersResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call orgDeleteReposCall(String org, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call orgDeleteReposValidateBeforeCall(String org, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'org' is set
        if (org == null) {
            throw new ApiException("Missing the required parameter 'org' when calling orgDeleteRepos(Async)");
        }
        

        com.squareup.okhttp.Call call = orgDeleteReposCall(org, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void orgDeleteRepos(String org) throws ApiException {
        orgDeleteReposWithHttpInfo(org);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> orgDeleteReposWithHttpInfo(String org) throws ApiException {
        com.squareup.okhttp.Call call = orgDeleteReposValidateBeforeCall(org, null, null);
        return apiClient.execute(call);
    }

    /**
     * Delete all repositories in an organization (asynchronously)
     * 
     * @param org name of the organization (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call orgDeleteReposAsync(String org, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = orgDeleteReposValidateBeforeCall(org, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
    ...
    /**
     * Build call for updateOrgRunner
     * @param org name of the organization (required)
     * @param runnerId id of the runner (required)
     * @param body  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateOrgRunnerCall(String org, String runnerId, EditActionRunnerOption body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateOrgRunnerValidateBeforeCall(String org, String runnerId, EditActionRunnerOption body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'org' is set
        if (org == null) {
            throw new ApiException("Missing the required parameter 'org' when calling updateOrgRunner(Async)");
        }
        
        // verify the required parameter 'runnerId' is set
        if (runnerId == null) {
            throw new ApiException("Missing the required parameter 'runnerId' when calling updateOrgRunner(Async)");
        }
        

        com.squareup.okhttp.Call call = updateOrgRunnerCall(org, runnerId, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ActionRunner updateOrgRunner(String org, String runnerId, EditActionRunnerOption body) throws ApiException {
        ApiResponse<ActionRunner> resp = updateOrgRunnerWithHttpInfo(org, runnerId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ActionRunner> updateOrgRunnerWithHttpInfo(String org, String runnerId, EditActionRunnerOption body) throws ApiException {
        com.squareup.okhttp.Call call = updateOrgRunnerValidateBeforeCall(org, runnerId, body, null, null);
        Type localVarReturnType = new TypeToken<ActionRunner>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update an org-level runner (asynchronously)
     * 
     * @param org name of the organization (required)
     * @param runnerId id of the runner (required)
     * @param body  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateOrgRunnerAsync(String org, String runnerId, EditActionRunnerOption body, final ApiCallback<ActionRunner> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateOrgRunnerValidateBeforeCall(org, runnerId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ActionRunner>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
