...
public class AddCollaboratorOption {
  /**
   * Permission level to grant the collaborator read RepoWritePermissionRead write RepoWritePermissionWrite admin RepoWritePermissionAdmin
   */
   ...
   * @return permission
  **/
  @ApiModelProperty(value = "Permission level to grant the collaborator read RepoWritePermissionRead write RepoWritePermissionWrite admin RepoWritePermissionAdmin")
