...
public class AnnotatedTag {
   ...
   * @return message
  **/
  @ApiModelProperty(value = "The message associated with the annotated tag")
  ...
  **/
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "The SHA hash of the annotated tag")
  ...
  **/
   ...
   * @return url
  **/
  @ApiModelProperty(value = "The URL to access the annotated tag")
