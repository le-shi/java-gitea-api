...
public class AnnotatedTagObject {
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "The SHA hash of the tagged object")
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of the tagged object (e.g., commit, tree)")
   ...
   * @return url
  **/
  @ApiModelProperty(value = "The URL to access the tagged object")
