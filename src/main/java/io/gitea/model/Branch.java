...
public class Branch {
  ...
  **/
  @ApiModelProperty(value = "EffectiveBranchProtectionName is the name of the effective branch protection rule")
  ...
  **/
  @ApiModelProperty(value = "EnableStatusCheck indicates if status checks are enabled")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Name is the branch name")
   ...
   * @return _protected
  **/
  @ApiModelProperty(value = "Protected indicates if the branch is protected")
  ...
  **/
  @ApiModelProperty(value = "RequiredApprovals is the number of required approvals for pull requests")
  ...
  **/
  @ApiModelProperty(value = "StatusCheckContexts contains the list of required status check contexts")
   ...
   * @return userCanMerge
  **/
  @ApiModelProperty(value = "UserCanMerge indicates if the current user can merge to this branch")
   ...
   * @return userCanPush
  **/
  @ApiModelProperty(value = "UserCanPush indicates if the current user can push to this branch")
