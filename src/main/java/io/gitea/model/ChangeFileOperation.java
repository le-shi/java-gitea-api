...
public class ChangeFileOperation {
   ...
   * @return content
  **/
  @ApiModelProperty(value = "new or updated file content, it must be base64 encoded")
  ...
  **/
   ...
   * @return operation
  **/
  @ApiModelProperty(required = true, value = "indicates what to do with the file: \"create\" for creating a new file, \"update\" for updating an existing file, \"upload\" for creating or updating a file, \"rename\" for renaming a file, and \"delete\" for deleting an existing file.")
  ...
  **/
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "the blob ID (SHA) for the file that already exists, required for changing existing files")
