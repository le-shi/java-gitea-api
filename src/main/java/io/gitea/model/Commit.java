...
public class Commit {
  ...
  **/
   ...
   * @return files
  **/
  @ApiModelProperty(value = "Files contains information about files affected by the commit")
   ...
   * @return htmlUrl
  **/
  @ApiModelProperty(value = "HTMLURL is the web URL for viewing the commit")
   ...
   * @return parents
  **/
  @ApiModelProperty(value = "Parents contains the parent commit information")
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "SHA is the commit SHA hash")
  ...
  **/
   ...
   * @return url
  **/
  @ApiModelProperty(value = "URL is the API URL for the commit")
