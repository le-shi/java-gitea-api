...
public class CreateOrgOption {
  ...
  /**
   * possible values are &#x60;public&#x60; (default), &#x60;limited&#x60; or &#x60;private&#x60; public UserVisibilityPublic limited UserVisibilityLimited private UserVisibilityPrivate
   */
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of the organization")
   ...
   * @return email
  **/
  @ApiModelProperty(value = "The email address of the organization")
   ...
   * @return fullName
  **/
  @ApiModelProperty(value = "The full display name of the organization")
   ...
   * @return location
  **/
  @ApiModelProperty(value = "The location of the organization")
  ...
  **/
  @ApiModelProperty(value = "Whether repository administrators can change team access")
   ...
   * @return username
  **/
  @ApiModelProperty(required = true, value = "username of the organization")
   ...
   * @return visibility
  **/
  @ApiModelProperty(value = "possible values are `public` (default), `limited` or `private` public UserVisibilityPublic limited UserVisibilityLimited private UserVisibilityPrivate")
   ...
   * @return website
  **/
  @ApiModelProperty(value = "The website URL of the organization")
