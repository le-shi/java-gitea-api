...
public class CreatePushMirrorOption {
  ...
  **/
  @ApiModelProperty(value = "The remote repository URL to push to")
  ...
  **/
  @ApiModelProperty(value = "The password for authentication with the remote repository")
  ...
  **/
  @ApiModelProperty(value = "The username for authentication with the remote repository")
