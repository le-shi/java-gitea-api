 ...
 */
@ApiModel(description = "DeleteFileOptions options for deleting a file Note: `author` and `committer` are optional (if only one is given, it will be used for the other, otherwise the authenticated user will be used)")
...
public class DeleteFileOptions {
  ...
  **/
   ...
   * @return sha
  **/
  @ApiModelProperty(required = true, value = "the blob ID (SHA) for the file to delete")
