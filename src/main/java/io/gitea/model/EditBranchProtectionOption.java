...
public class EditBranchProtectionOption {
  ...
  @SerializedName("bypass_allowlist_teams")
  private List<String> bypassAllowlistTeams = null;

  @SerializedName("bypass_allowlist_usernames")
  private List<String> bypassAllowlistUsernames = null;
  ...
  @SerializedName("enable_bypass_allowlist")
  private Boolean enableBypassAllowlist = null;
  ...
  **/
  ...
  public EditBranchProtectionOption bypassAllowlistTeams(List<String> bypassAllowlistTeams) {
    this.bypassAllowlistTeams = bypassAllowlistTeams;
    return this;
  }

  public EditBranchProtectionOption addBypassAllowlistTeamsItem(String bypassAllowlistTeamsItem) {
    if (this.bypassAllowlistTeams == null) {
      this.bypassAllowlistTeams = new ArrayList<String>();
    }
    this.bypassAllowlistTeams.add(bypassAllowlistTeamsItem);
    return this;
  }

   /**
   * Get bypassAllowlistTeams
   * @return bypassAllowlistTeams
  **/
  @ApiModelProperty(value = "")
  public List<String> getBypassAllowlistTeams() {
    return bypassAllowlistTeams;
  }

  public void setBypassAllowlistTeams(List<String> bypassAllowlistTeams) {
    this.bypassAllowlistTeams = bypassAllowlistTeams;
  }

  public EditBranchProtectionOption bypassAllowlistUsernames(List<String> bypassAllowlistUsernames) {
    this.bypassAllowlistUsernames = bypassAllowlistUsernames;
    return this;
  }

  public EditBranchProtectionOption addBypassAllowlistUsernamesItem(String bypassAllowlistUsernamesItem) {
    if (this.bypassAllowlistUsernames == null) {
      this.bypassAllowlistUsernames = new ArrayList<String>();
    }
    this.bypassAllowlistUsernames.add(bypassAllowlistUsernamesItem);
    return this;
  }

   /**
   * Get bypassAllowlistUsernames
   * @return bypassAllowlistUsernames
  **/
  @ApiModelProperty(value = "")
  public List<String> getBypassAllowlistUsernames() {
    return bypassAllowlistUsernames;
  }

  public void setBypassAllowlistUsernames(List<String> bypassAllowlistUsernames) {
    this.bypassAllowlistUsernames = bypassAllowlistUsernames;
  }
  ...
  **/
  ...
  public EditBranchProtectionOption enableBypassAllowlist(Boolean enableBypassAllowlist) {
    this.enableBypassAllowlist = enableBypassAllowlist;
    return this;
  }

   /**
   * Get enableBypassAllowlist
   * @return enableBypassAllowlist
  **/
  @ApiModelProperty(value = "")
  public Boolean isEnableBypassAllowlist() {
    return enableBypassAllowlist;
  }

  public void setEnableBypassAllowlist(Boolean enableBypassAllowlist) {
    this.enableBypassAllowlist = enableBypassAllowlist;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.approvalsWhitelistTeams, editBranchProtectionOption.approvalsWhitelistTeams) &&
        ...
        Objects.equals(this.bypassAllowlistTeams, editBranchProtectionOption.bypassAllowlistTeams) &&
        Objects.equals(this.bypassAllowlistUsernames, editBranchProtectionOption.bypassAllowlistUsernames) &&
        ...
        Objects.equals(this.enableBypassAllowlist, editBranchProtectionOption.enableBypassAllowlist) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(approvalsWhitelistTeams, approvalsWhitelistUsername, blockAdminMergeOverride, blockOnOfficialReviewRequests, blockOnOutdatedBranch, blockOnRejectedReviews, bypassAllowlistTeams, bypassAllowlistUsernames, dismissStaleApprovals, enableApprovalsWhitelist, enableBypassAllowlist, enableForcePush, enableForcePushAllowlist, enableMergeWhitelist, enablePush, enablePushWhitelist, enableStatusCheck, forcePushAllowlistDeployKeys, forcePushAllowlistTeams, forcePushAllowlistUsernames, ignoreStaleApprovals, mergeWhitelistTeams, mergeWhitelistUsernames, priority, protectedFilePatterns, pushWhitelistDeployKeys, pushWhitelistTeams, pushWhitelistUsernames, requireSignedCommits, requiredApprovals, statusCheckContexts, unprotectedFilePatterns);
  }
