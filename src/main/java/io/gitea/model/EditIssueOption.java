...
public class EditIssueOption {
  ...
  **/
  @ApiModelProperty(value = "The current version of the issue content to detect conflicts during editing")
  ...
  **/
   ...
   * @return projects
  **/
  @ApiModelProperty(value = "list of project ids to set (replaces existing projects)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignee, assignees, body, contentVersion, dueDate, milestone, projects, ref, state, title, unsetDueDate);
  }
