...
public class EditMilestoneOption {
   ...
   * @return description
  **/
  @ApiModelProperty(value = "Description provides updated details about the milestone")
   ...
   * @return dueOn
  **/
  @ApiModelProperty(value = "Deadline is the updated due date for the milestone")
   ...
   * @return state
  **/
  @ApiModelProperty(value = "State indicates the updated state of the milestone")
   ...
   * @return title
  **/
  @ApiModelProperty(value = "Title is the updated title of the milestone")
