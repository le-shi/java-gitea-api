...
public class EditPullRequestOption {
  ...
  **/
  @ApiModelProperty(value = "The current version of the pull request content to detect conflicts during editing")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMaintainerEdit, assignee, assignees, base, body, contentVersion, dueDate, labels, milestone, state, title, unsetDueDate);
  }
