...
public class EditRepoOption {
  ...
  @SerializedName("allow_merge_update")
  private Boolean allowMergeUpdate = null;
  ...
  @SerializedName("default_update_style")
  private String defaultUpdateStyle = null;
  ...
  **/
  @ApiModelProperty(value = "either `true` to allow fast-forward-only merging pull requests, or `false` to prevent fast-forward-only merging.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to allow mark pr as merged manually, or `false` to prevent it.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to allow merging pull requests with a merge commit, or `false` to prevent merging pull requests with merge commits.")
  ...
  public EditRepoOption allowMergeUpdate(Boolean allowMergeUpdate) {
    this.allowMergeUpdate = allowMergeUpdate;
    return this;
  }

   /**
   * either &#x60;true&#x60; to allow updating pull request branch by merge, or &#x60;false&#x60; to prevent it.
   * @return allowMergeUpdate
  **/
  @ApiModelProperty(value = "either `true` to allow updating pull request branch by merge, or `false` to prevent it.")
  public Boolean isAllowMergeUpdate() {
    return allowMergeUpdate;
  }

  public void setAllowMergeUpdate(Boolean allowMergeUpdate) {
    this.allowMergeUpdate = allowMergeUpdate;
  }
   ...
   * @return allowRebase
  **/
  @ApiModelProperty(value = "either `true` to allow rebase-merging pull requests, or `false` to prevent rebase-merging.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to allow rebase with explicit merge commits (--no-ff), or `false` to prevent rebase with explicit merge commits.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to allow updating pull request branch by rebase, or `false` to prevent it.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to allow squash-merging pull requests, or `false` to prevent squash-merging.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to enable AutodetectManualMerge, or `false` to prevent it. Note: In some special cases, misjudgments can occur.")
  ...
  **/
  @ApiModelProperty(value = "set to `true` to allow edits from maintainers by default")
  ...
  **/
  @ApiModelProperty(value = "set to a merge style to be used by this repository: \"merge\", \"rebase\", \"rebase-merge\", \"squash\", or \"fast-forward-only\".")
  ...
  public EditRepoOption defaultUpdateStyle(String defaultUpdateStyle) {
  ...
  **/
  @ApiModelProperty(value = "set to an update style to be used by this repository: \"merge\" or \"rebase\".")
  public String getDefaultUpdateStyle() {
    return defaultUpdateStyle;
  }

  public void setDefaultUpdateStyle(String defaultUpdateStyle) {
    this.defaultUpdateStyle = defaultUpdateStyle;
  }
  ...
  **/
   ...
   * @return enablePrune
  **/
  @ApiModelProperty(value = "enable prune - remove obsolete remote-tracking references when mirroring")
  ...
  **/
   ...
   * @return hasActions
  **/
  @ApiModelProperty(value = "either `true` to enable actions unit, or `false` to disable them.")
   ...
   * @return hasCode
  **/
  @ApiModelProperty(value = "either `true` to enable code for this repository or `false` to disable it.")
  ...
  **/
   ...
   * @return hasPackages
  **/
  @ApiModelProperty(value = "either `true` to enable packages unit, or `false` to disable them.")
  ...
  **/
   ...
   * @return hasReleases
  **/
  @ApiModelProperty(value = "either `true` to enable releases unit, or `false` to disable them.")
  ...
  **/
  @ApiModelProperty(value = "either `true` to ignore whitespace for conflicts, or `false` to not ignore whitespace.")
  ...
  **/
  @ApiModelProperty(value = "authentication password for the remote repository (mirrors)")
   ...
   * @return mirrorToken
  **/
  @ApiModelProperty(value = "authentication token for the remote repository (mirrors)")
  ...
  **/
  @ApiModelProperty(value = "authentication username for the remote repository (mirrors)")
  ...
  **/
   ...
   * @return projectsMode
  **/
  @ApiModelProperty(value = "`repo` to only allow repo-level projects, `owner` to only allow owner projects, `all` to allow both.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.allowFastForwardOnlyMerge, editRepoOption.allowFastForwardOnlyMerge) &&
        ...
        Objects.equals(this.allowMergeUpdate, editRepoOption.allowMergeUpdate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowFastForwardOnlyMerge, allowManualMerge, allowMergeCommits, allowMergeUpdate, allowRebase, allowRebaseExplicit, allowRebaseUpdate, allowSquashMerge, archived, autodetectManualMerge, defaultAllowMaintainerEdit, defaultBranch, defaultDeleteBranchAfterMerge, defaultMergeStyle, defaultUpdateStyle, description, enablePrune, externalTracker, externalWiki, hasActions, hasCode, hasIssues, hasPackages, hasProjects, hasPullRequests, hasReleases, hasWiki, ignoreWhitespaceConflicts, internalTracker, mirrorInterval, mirrorPassword, mirrorToken, mirrorUsername, name, _private, projectsMode, template, website);
  }
