...
public class EditRepoOption {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowFastForwardOnlyMerge, allowManualMerge, allowMergeCommits, allowRebase, allowRebaseExplicit, allowRebaseUpdate, allowSquashMerge, archived, autodetectManualMerge, defaultAllowMaintainerEdit, defaultBranch, defaultDeleteBranchAfterMerge, defaultMergeStyle, description, enablePrune, externalTracker, externalWiki, hasActions, hasCode, hasIssues, hasPackages, hasProjects, hasPullRequests, hasReleases, hasWiki, ignoreWhitespaceConflicts, internalTracker, mirrorInterval, name, _private, projectsMode, template, website);
  }
