...
public class FileCommitResponse {
  ...
  **/
   ...
   * @return htmlUrl
  **/
  @ApiModelProperty(value = "HTMLURL is the web URL for viewing this commit")
   ...
   * @return message
  **/
  @ApiModelProperty(value = "Message is the commit message")
   ...
   * @return parents
  **/
  @ApiModelProperty(value = "Parents contains parent commit metadata")
