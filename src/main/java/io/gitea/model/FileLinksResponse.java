...
public class FileLinksResponse {
   ...
   * @return git
  **/
  @ApiModelProperty(value = "GitURL is the Git API URL for this file")
   ...
   * @return html
  **/
  @ApiModelProperty(value = "HTMLURL is the web URL for this file")
   ...
   * @return self
  **/
  @ApiModelProperty(value = "Self is the API URL for this file")
