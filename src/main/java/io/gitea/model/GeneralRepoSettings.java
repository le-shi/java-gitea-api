...
public class GeneralRepoSettings {
  ...
  **/
  @ApiModelProperty(value = "HTTPGitDisabled indicates if HTTP Git operations are disabled")
   ...
   * @return lfsDisabled
  **/
  @ApiModelProperty(value = "LFSDisabled indicates if Git LFS support is disabled")
  ...
  **/
  @ApiModelProperty(value = "MigrationsDisabled indicates if repository migrations are disabled")
  ...
  **/
  @ApiModelProperty(value = "MirrorsDisabled indicates if repository mirroring is disabled")
  ...
  **/
  @ApiModelProperty(value = "StarsDisabled indicates if repository starring is disabled")
  ...
  **/
  @ApiModelProperty(value = "TimeTrackingDisabled indicates if time tracking is disabled")
