...
public class GeneralUISettings {
  ...
  **/
  @ApiModelProperty(value = "AllowedReactions contains the list of allowed emoji reactions")
   ...
   * @return customEmojis
  **/
  @ApiModelProperty(value = "CustomEmojis contains the list of custom emojis")
   ...
   * @return defaultTheme
  **/
  @ApiModelProperty(value = "DefaultTheme is the default UI theme")
