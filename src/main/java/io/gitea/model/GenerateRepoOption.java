 ...
 */
@ApiModel(description = "GenerateRepoOption options when creating a repository using a template")
...
public class GenerateRepoOption {
  ...
  **/
   ...
   * @return owner
  **/
  @ApiModelProperty(required = true, value = "the organization's name or individual user's name who will own the new repository")
  ...
  **/
  @ApiModelProperty(value = "include protected branches in template repo")
