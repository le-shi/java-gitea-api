...
public class GitObject {
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "The SHA hash of the Git object")
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of the Git object (e.g., commit, tag, tree, blob)")
   ...
   * @return url
  **/
  @ApiModelProperty(value = "The URL to access this Git object")
