...
public class Issue {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assets, assignee, assignees, body, closedAt, comments, contentVersion, createdAt, dueDate, htmlUrl, id, isLocked, labels, milestone, number, originalAuthor, originalAuthorId, pinOrder, pullRequest, ref, repository, state, timeEstimate, title, updatedAt, url, user);
  }
