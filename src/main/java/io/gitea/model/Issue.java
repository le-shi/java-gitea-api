...
public class Issue {
  ...
  **/
  @ApiModelProperty(value = "The version of the issue content for optimistic locking")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assets, assignee, assignees, body, closedAt, comments, contentVersion, createdAt, dueDate, htmlUrl, id, isLocked, labels, milestone, number, originalAuthor, originalAuthorId, pinOrder, projects, pullRequest, ref, repository, state, timeEstimate, title, updatedAt, url, user);
  }
