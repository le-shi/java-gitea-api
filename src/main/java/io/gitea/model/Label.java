...
public class Label {
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(value = "ID is the unique identifier for the label")
  public Long getId() {
    return id;
  }
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Name is the display name of the label")
   ...
   * @return url
  **/
  @ApiModelProperty(value = "URL is the API endpoint for accessing this label")
