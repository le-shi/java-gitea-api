...
public class MarkupOption {
   ...
   * @return context
  **/
  @ApiModelProperty(value = "URL path for rendering issue, media and file links Expected format: /subpath/{user}/{repo}/src/{branch, commit, tag}/{identifier/path}/{file/dir}")
   ...
   * @return filePath
  **/
  @ApiModelProperty(value = "File path for detecting extension in file mode")
   ...
   * @return mode
  **/
  @ApiModelProperty(value = "Mode to render (markdown, comment, wiki, file)")
   ...
   * @return text
  **/
  @ApiModelProperty(value = "Text markup to render")
   ...
   * @return wiki
  **/
  @ApiModelProperty(value = "Is it a wiki page? (use mode=wiki instead)  Deprecated: true")
