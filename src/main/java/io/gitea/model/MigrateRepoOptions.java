...
public class MigrateRepoOptions {
  ...
  **/
   ...
   * @return repoOwner
  **/
  @ApiModelProperty(value = "the organization's name or individual user's name who will own the migrated repository")
  ...
  **/
   ...
   * @return uid
  **/
  @ApiModelProperty(value = "deprecated (only for backwards compatibility, use repo_owner instead)")
  public Long getUid() {
    return uid;
  }
