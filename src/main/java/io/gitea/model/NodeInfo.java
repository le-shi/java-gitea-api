...
public class NodeInfo {
   ...
   * @return metadata
  **/
  @ApiModelProperty(value = "Metadata contains free form key value pairs for software specific values")
  ...
  **/
  @ApiModelProperty(value = "OpenRegistrations indicates if new user registrations are accepted")
   ...
   * @return protocols
  **/
  @ApiModelProperty(value = "Protocols lists the protocols supported by this server")
  ...
  **/
   ...
   * @return version
  **/
  @ApiModelProperty(value = "Version specifies the schema version")
