...
public class NodeInfoServices {
   ...
   * @return inbound
  **/
  @ApiModelProperty(value = "Inbound lists services that can deliver content to this server")
   ...
   * @return outbound
  **/
  @ApiModelProperty(value = "Outbound lists services this server can deliver content to")
