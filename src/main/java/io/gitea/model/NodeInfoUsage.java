...
public class NodeInfoUsage {
  ...
  **/
  @ApiModelProperty(value = "LocalComments is the total amount of comments made by users local to this server")
   ...
   * @return localPosts
  **/
  @ApiModelProperty(value = "LocalPosts is the total amount of posts made by users local to this server")
