...
public class NotificationThread {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "ID is the unique identifier for the notification thread")
  public Long getId() {
    return id;
  }
   ...
   * @return pinned
  **/
  @ApiModelProperty(value = "Pinned indicates if the notification is pinned")
  ...
  **/
   ...
   * @return unread
  **/
  @ApiModelProperty(value = "Unread indicates if the notification has been read")
   ...
   * @return updatedAt
  **/
  @ApiModelProperty(value = "UpdatedAt is the time when the notification was last updated")
   ...
   * @return url
  **/
  @ApiModelProperty(value = "URL is the API URL for this notification thread")
