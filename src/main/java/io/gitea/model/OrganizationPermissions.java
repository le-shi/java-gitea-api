...
public class OrganizationPermissions {
  ...
  **/
  @ApiModelProperty(value = "Whether the user can create repositories in the organization")
   ...
   * @return canRead
  **/
  @ApiModelProperty(value = "Whether the user can read the organization")
   ...
   * @return canWrite
  **/
  @ApiModelProperty(value = "Whether the user can write to the organization")
   ...
   * @return isAdmin
  **/
  @ApiModelProperty(value = "Whether the user is an admin of the organization")
   ...
   * @return isOwner
  **/
  @ApiModelProperty(value = "Whether the user is an owner of the organization")
