...
public class PRBranchInfo {
   ...
   * @return label
  **/
  @ApiModelProperty(value = "The display name of the branch")
   ...
   * @return ref
  **/
  @ApiModelProperty(value = "The git reference of the branch")
  ...
  **/
   ...
   * @return repoId
  **/
  @ApiModelProperty(value = "The unique identifier of the repository")
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "The commit SHA of the branch head")
