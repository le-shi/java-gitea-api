...
public class PackageFile {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The unique identifier of the package file")
  public Long getId() {
    return id;
  }
   ...
   * @return md5
  **/
  @ApiModelProperty(value = "The MD5 hash of the package file")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name of the package file")
   ...
   * @return sha1
  **/
  @ApiModelProperty(value = "The SHA1 hash of the package file")
   ...
   * @return sha256
  **/
  @ApiModelProperty(value = "The SHA256 hash of the package file")
   ...
   * @return sha512
  **/
  @ApiModelProperty(value = "The SHA512 hash of the package file")
   ...
   * @return size
  **/
  @ApiModelProperty(value = "The size of the package file in bytes")
  public Long getSize() {
    return size;
  }
