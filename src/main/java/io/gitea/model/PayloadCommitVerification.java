...
public class PayloadCommitVerification {
   ...
   * @return payload
  **/
  @ApiModelProperty(value = "The signed payload content")
   ...
   * @return reason
  **/
  @ApiModelProperty(value = "The reason for the verification status")
   ...
   * @return signature
  **/
  @ApiModelProperty(value = "The GPG signature of the commit")
  ...
  **/
   ...
   * @return verified
  **/
  @ApiModelProperty(value = "Whether the commit signature is verified")
