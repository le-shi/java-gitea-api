...
public class PublicKey {
  ...
  **/
   ...
   * @return fingerprint
  **/
  @ApiModelProperty(value = "Fingerprint is the key's fingerprint")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "ID is the unique identifier for the public key")
  public Long getId() {
    return id;
  }
   ...
   * @return key
  **/
  @ApiModelProperty(value = "Key contains the actual SSH public key content")
   ...
   * @return keyType
  **/
  @ApiModelProperty(value = "KeyType indicates the type of the SSH key")
  ...
  public PublicKey lastUsedAt(OffsetDateTime lastUsedAt) {
   ...
   * @return lastUsedAt
  **/
  @ApiModelProperty(value = "Updated is the time when the key was last used")
   ...
   * @return readOnly
  **/
  @ApiModelProperty(value = "ReadOnly indicates if the key has read-only access")
   ...
   * @return title
  **/
  @ApiModelProperty(value = "Title is the human-readable name for the key")
   ...
   * @return url
  **/
  @ApiModelProperty(value = "URL is the API URL for this key")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, fingerprint, id, key, keyType, lastUsedAt, readOnly, title, url, user);
  }
