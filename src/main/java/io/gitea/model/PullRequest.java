...
public class PullRequest {
  ...
  /**
   * The current state of the pull request open StateOpen  StateOpen pr is opened closed StateClosed  StateClosed pr is closed
   */
  ...
  **/
  @ApiModelProperty(value = "The version of the pull request content for optimistic locking")
  ...
  **/
   ...
   * @return state
  **/
  @ApiModelProperty(value = "The current state of the pull request open StateOpen  StateOpen pr is opened closed StateClosed  StateClosed pr is closed")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additions, allowMaintainerEdit, assignee, assignees, base, body, changedFiles, closedAt, comments, contentVersion, createdAt, deletions, diffUrl, draft, dueDate, head, htmlUrl, id, isLocked, labels, mergeBase, mergeCommitSha, mergeable, merged, mergedAt, mergedBy, milestone, number, patchUrl, pinOrder, requestedReviewers, requestedReviewersTeams, reviewComments, state, title, updatedAt, url, user);
  }
