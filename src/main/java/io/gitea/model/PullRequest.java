...
public class PullRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additions, allowMaintainerEdit, assignee, assignees, base, body, changedFiles, closedAt, comments, createdAt, deletions, diffUrl, draft, dueDate, head, htmlUrl, id, isLocked, labels, mergeBase, mergeCommitSha, mergeable, merged, mergedAt, mergedBy, milestone, number, patchUrl, pinOrder, requestedReviewers, reviewComments, state, title, updatedAt, url, user);
  }
