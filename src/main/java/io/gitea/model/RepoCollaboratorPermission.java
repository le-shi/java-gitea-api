...
public class RepoCollaboratorPermission {
  /**
   * Permission level of the collaborator none AccessLevelNameNone read AccessLevelNameRead write AccessLevelNameWrite admin AccessLevelNameAdmin owner AccessLevelNameOwner
   */
   ...
   * @return permission
  **/
  @ApiModelProperty(value = "Permission level of the collaborator none AccessLevelNameNone read AccessLevelNameRead write AccessLevelNameWrite admin AccessLevelNameAdmin owner AccessLevelNameOwner")
   ...
   * @return roleName
  **/
  @ApiModelProperty(value = "RoleName is the name of the permission role")
