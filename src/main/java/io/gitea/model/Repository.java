...
public class Repository {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowFastForwardOnlyMerge, allowMergeCommits, allowRebase, allowRebaseExplicit, allowRebaseUpdate, allowSquashMerge, archived, archivedAt, avatarUrl, cloneUrl, createdAt, defaultAllowMaintainerEdit, defaultBranch, defaultDeleteBranchAfterMerge, defaultMergeStyle, description, empty, externalTracker, externalWiki, fork, forksCount, fullName, hasActions, hasIssues, hasPackages, hasProjects, hasPullRequests, hasReleases, hasWiki, htmlUrl, id, ignoreWhitespaceConflicts, internal, internalTracker, language, languagesUrl, link, mirror, mirrorInterval, mirrorUpdated, name, objectFormatName, openIssuesCount, openPrCounter, originalUrl, owner, parent, permissions, _private, projectsMode, releaseCounter, repoTransfer, size, sshUrl, starsCount, template, updatedAt, url, watchersCount, website);
  }
