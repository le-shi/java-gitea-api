...
public class Repository {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMergeCommits, allowRebase, allowRebaseExplicit, allowRebaseUpdate, allowSquashMerge, archived, archivedAt, avatarUrl, cloneUrl, createdAt, defaultAllowMaintainerEdit, defaultBranch, defaultDeleteBranchAfterMerge, defaultMergeStyle, description, empty, externalTracker, externalWiki, fork, forksCount, fullName, hasActions, hasIssues, hasPackages, hasProjects, hasPullRequests, hasReleases, hasWiki, htmlUrl, id, ignoreWhitespaceConflicts, internal, internalTracker, language, languagesUrl, link, mirror, mirrorInterval, mirrorUpdated, name, openIssuesCount, openPrCounter, originalUrl, owner, parent, permissions, _private, releaseCounter, repoTransfer, size, sshUrl, starsCount, template, updatedAt, url, watchersCount, website);
  }
