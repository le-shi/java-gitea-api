...
public class Repository {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowFastForwardOnlyMerge, allowManualMerge, allowMergeCommits, allowRebase, allowRebaseExplicit, allowRebaseUpdate, allowSquashMerge, archived, archivedAt, autodetectManualMerge, avatarUrl, cloneUrl, createdAt, defaultAllowMaintainerEdit, defaultBranch, defaultDeleteBranchAfterMerge, defaultMergeStyle, description, empty, externalTracker, externalWiki, fork, forksCount, fullName, hasActions, hasCode, hasIssues, hasPackages, hasProjects, hasPullRequests, hasReleases, hasWiki, htmlUrl, id, ignoreWhitespaceConflicts, internal, internalTracker, language, languagesUrl, licenses, link, mirror, mirrorInterval, mirrorUpdated, name, objectFormatName, openIssuesCount, openPrCounter, originalUrl, owner, parent, permissions, _private, projectsMode, releaseCounter, repoTransfer, size, sshUrl, starsCount, template, topics, updatedAt, url, watchersCount, website);
  }
