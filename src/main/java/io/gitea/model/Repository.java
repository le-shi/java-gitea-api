...
public class Repository {
  ...
  private OffsetDateTime mirrorLastSyncAt = null;
  ...
  public enum ObjectFormatNameEnum {
    ...
    public static ObjectFormatNameEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<ObjectFormatNameEnum> {
      ...
      public ObjectFormatNameEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return ObjectFormatNameEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  **/
  ...
  public Repository allowMergeUpdate(Boolean allowMergeUpdate) {
    this.allowMergeUpdate = allowMergeUpdate;
    return this;
  }

   /**
   * Get allowMergeUpdate
  ...
  **/
  ...
  public Repository defaultUpdateStyle(String defaultUpdateStyle) {
  ...
  **/
  ...
  public Repository mirrorLastSyncAt(OffsetDateTime mirrorLastSyncAt) {
  ...
  **/
  @ApiModelProperty(value = "")
  public OffsetDateTime getMirrorLastSyncAt() {
    return mirrorLastSyncAt;
  }

  public void setMirrorLastSyncAt(OffsetDateTime mirrorLastSyncAt) {
    this.mirrorLastSyncAt = mirrorLastSyncAt;
  }
  ...
  **/
  @ApiModelProperty(value = "ObjectFormatName of the underlying git repository sha1 ObjectFormatSHA1 sha256 ObjectFormatSHA256")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.allowFastForwardOnlyMerge, repository.allowFastForwardOnlyMerge) &&
        ...
        Objects.equals(this.allowMergeUpdate, repository.allowMergeUpdate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowFastForwardOnlyMerge, allowManualMerge, allowMergeCommits, allowMergeUpdate, allowRebase, allowRebaseExplicit, allowRebaseUpdate, allowSquashMerge, archived, archivedAt, autodetectManualMerge, avatarUrl, branchCount, cloneUrl, createdAt, defaultAllowMaintainerEdit, defaultBranch, defaultDeleteBranchAfterMerge, defaultMergeStyle, defaultTargetBranch, defaultUpdateStyle, description, empty, externalTracker, externalWiki, fork, forksCount, fullName, hasActions, hasCode, hasIssues, hasPackages, hasProjects, hasPullRequests, hasReleases, hasWiki, htmlUrl, id, ignoreWhitespaceConflicts, internal, internalTracker, language, languagesUrl, licenses, link, mirror, mirrorInterval, mirrorLastSyncAt, mirrorUpdated, name, objectFormatName, openIssuesCount, openPrCounter, originalUrl, owner, parent, permissions, _private, projectsMode, releaseCounter, repoTransfer, size, sshUrl, starsCount, template, topics, updatedAt, url, watchersCount, website);
  }
  ...
  public String toString() {
    ...
    sb.append("    defaultTargetBranch: ").append(toIndentedString(defaultTargetBranch)).append("\n");
