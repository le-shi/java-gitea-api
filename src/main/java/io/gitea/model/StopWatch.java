...
public class StopWatch {
  ...
  **/
   ...
   * @return duration
  **/
  @ApiModelProperty(value = "Duration is a human-readable duration string")
   ...
   * @return issueIndex
  **/
  @ApiModelProperty(value = "IssueIndex is the index number of the associated issue")
   ...
   * @return issueTitle
  **/
  @ApiModelProperty(value = "IssueTitle is the title of the associated issue")
   ...
   * @return repoName
  **/
  @ApiModelProperty(value = "RepoName is the name of the repository")
  ...
  **/
  @ApiModelProperty(value = "RepoOwnerName is the name of the repository owner")
   ...
   * @return seconds
  **/
  @ApiModelProperty(value = "Seconds is the total elapsed time in seconds")
