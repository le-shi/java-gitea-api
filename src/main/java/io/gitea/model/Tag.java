...
public class Tag {
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The ID (SHA) of the tag")
  public String getId() {
    return id;
  }
   ...
   * @return message
  **/
  @ApiModelProperty(value = "The message associated with the tag")
  ...
  **/
   ...
   * @return zipballUrl
  **/
  @ApiModelProperty(value = "The URL to download the zipball archive")
