...
public class TimelineComment {
  ...
  **/
   ...
   * @return body
  **/
  @ApiModelProperty(value = "Body contains the timeline event content")
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(value = "ID is the unique identifier for the timeline comment")
  public Long getId() {
    return id;
  }
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(value = "Type indicates the type of timeline event")
