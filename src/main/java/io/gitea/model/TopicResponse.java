...
public class TopicResponse {
   ...
   * @return created
  **/
  @ApiModelProperty(value = "The date and time when the topic was created")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The unique identifier of the topic")
  public Long getId() {
    return id;
  }
   ...
   * @return repoCount
  **/
  @ApiModelProperty(value = "The number of repositories using this topic")
  ...
  **/
   ...
   * @return updated
  **/
  @ApiModelProperty(value = "The date and time when the topic was last updated")
