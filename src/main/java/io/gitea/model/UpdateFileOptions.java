 ...
 */
@ApiModel(description = "UpdateFileOptions options for updating or creating a file Note: `author` and `committer` are optional (if only one is given, it will be used for the other, otherwise the authenticated user will be used)")
...
public class UpdateFileOptions {
  ...
  **/
   ...
   * @return sha
  **/
  @ApiModelProperty(value = "the blob ID (SHA) for the file that already exists to update, or leave it empty to create a new file")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(author, branch, committer, content, dates, forcePush, fromPath, message, newBranch, sha, signoff);
  }
