...
public class WikiPage {
   ...
   * @return commitCount
  **/
  @ApiModelProperty(value = "The number of commits that modified this page")
  ...
  **/
   ...
   * @return footer
  **/
  @ApiModelProperty(value = "The footer content for the wiki page")
   ...
   * @return htmlUrl
  **/
  @ApiModelProperty(value = "The HTML URL to view the wiki page")
  ...
  **/
   ...
   * @return sidebar
  **/
  @ApiModelProperty(value = "The sidebar content for the wiki page")
   ...
   * @return subUrl
  **/
  @ApiModelProperty(value = "The sub URL path for the wiki page")
   ...
   * @return title
  **/
  @ApiModelProperty(value = "The title of the wiki page")
