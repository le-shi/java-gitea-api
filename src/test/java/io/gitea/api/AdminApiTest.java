...
public class AdminApiTest {
    ...
    public void adminSearchUsersTest() throws ApiException {
        ...
        Boolean is2faEnabled = null;
        Boolean isProhibitLogin = null;
        List<User> response = api.adminSearchUsers(sourceId, loginName, page, limit, sort, order, q, visibility, isActive, isAdmin, isRestricted, is2faEnabled, isProhibitLogin);
    ...
    public void getAdminRunnerTest() throws ApiException {
        String runnerId = null;
        ActionRunner response = api.getAdminRunner(runnerId);
    ...
    public void getAdminRunnersTest() throws ApiException {
        ...
        ActionRunnersResponse response = api.getAdminRunners(disabled);
    ...
    public void listAdminWorkflowJobsTest() throws ApiException {
        ...
        String sort = null;
        String order = null;
        ActionWorkflowJobsResponse response = api.listAdminWorkflowJobs(status, page, limit, sort, order);
     ...
     */
    @Test
    public void updateAdminRunnerTest() throws ApiException {
        String runnerId = null;
        EditActionRunnerOption body = null;
        ActionRunner response = api.updateAdminRunner(runnerId, body);
